...
public class UserManager {
     ...
     */
    public boolean returnCar(String username, int carId) {
        ...
        // Update cars purchased count
        user.setCarsPurchased(user.getCarsPurchased() - 1);

        // Update the cars available in inventory
        ...
        System.out.println("Car returned successfully. Refund amount: $" + refundAmount);
        return true;
    }
}